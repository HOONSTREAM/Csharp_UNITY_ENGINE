...
public class PlayerController : MonoBehaviour
{
    ...
    void UpdateMoving()
    {
        ...
        {
            float MoveDist = Mathf.Clamp(_speed * Time.deltaTime, 0, dir.magnitude); //거리,최솟값,최댓값
    ...
    void Start()
    {
        ...
        Managers.Resources.Instantiate("UI/UI_Score_Button_Test"); //싱글톤 Manager를 활용하여 UI를 불러온다.
    }
